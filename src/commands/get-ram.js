...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('get-ram')
        .setDescription(commandDescriptions['get-ram'])
    ...
    async run(bot, interaction) {
        try{ 
            ...
            console.error(`An error ocurred while running the command 'get-ram' executed by ${interaction.user.tag}(${interaction.user.id}): ${e}`)
