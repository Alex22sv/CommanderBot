...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('set-ram')
        .setDescription(commandDescriptions['set-ram'])
    ...
    async run(bot, interaction) {
        try{ 
            ...
            console.error(`An error ocurred while running the command 'set-ram' executed by ${interaction.user.tag}(${interaction.user.id}): ${e}`)
