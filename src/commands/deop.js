...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('deop')
        .setDescription(commandDescriptions.deop)
    ...
    async run(bot, interaction) {
        try{ 
            ...
            console.error(`An error ocurred while running the command 'deop' executed by ${interaction.user.tag}(${interaction.user.id}): ${e}`)
